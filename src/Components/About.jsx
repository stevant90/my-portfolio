...
const About = () => (
    <div className="About">
        ...
        <div className="About__content">
            ...
            <p className="About__text">I work as a front-end developer. I live in Belgrade, and I have a big passion for web programming. I enjoy building feature rich and nice looking web pages. My biggest passion about for programming is a building single page applications, especially using React.js. I enjoy working with React because it makes nice looking either web pages and code in the background. I also write unit tests for apps and exercises I work on, using Jest and Enzyme for testing React components.
            </p>
